...
const styles = StyleSheet.create({
  ...
  dayHeaderText: { ...typography.caption, color: colors.gray400 },
  calendarGrid: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    gap: spacing.xs,
  ...
  summaryTitle: { ...typography.h3, color: colors.white, marginBottom: spacing.md },
  summaryGrid: { flexDirection: 'row', justifyContent: 'space-between' },
  summaryItem: { alignItems: 'center' },
  summaryItemValue: { ...typography.h2, color: colors.white },
  summaryItemLabel: { ...typography.caption, color: colors.gray400, marginTop: spacing.xxs },
  hintBar: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.sm,
