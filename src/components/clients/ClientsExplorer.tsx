...
import { colors, radii, spacing, statusColors, statusLabels, typography } from '../../theme';
import { TopHeader } from '../layout/TopHeader';
import { EmptyState } from '../ui/EmptyState';
import { LoadingState } from '../ui/LoadingState';
import { getOwnerClientDetail, getOwnerClients } from '../../services/ownerApi';
import type {
...
export function ClientsExplorer({
  ...
  return (
    <View style={styles.container}>
      {showHeader ? <TopHeader title="Clientes" subtitle={subtitle} /> : null}

      <View style={[styles.content, !showHeader && styles.embeddedContent, contentStyle]}>
