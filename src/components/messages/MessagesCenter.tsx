...
import type { RescheduleSimulationResult } from '../modals/RescheduleModal';
...
export function MessagesCenter({ showHeader = false }: MessagesCenterProps) {
  ...
  return (
    <View style={styles.container}>
      {showHeader ? <TopHeader title="Mensajes" subtitle="Canal WhatsApp del estudio" /> : null}
