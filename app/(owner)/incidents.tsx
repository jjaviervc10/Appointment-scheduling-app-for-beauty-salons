...
import { fetchActiveIncidents } from '../../src/services/incidents';
import type { Incident } from '../../src/types/database';
...
export default function IncidentsScreen() {
  ...
  const handleCreateIncident = () => {
    ...
    // TODO: Call createIncident service
    Alert.alert(
      'Incidencia registrada',
      'Se bloqueará el horario y se notificará a los clientes afectados.',
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          <Text style={styles.headerTitle}>Incidencia / emergencia</Text>
          <Text style={styles.headerSubtitle}>
            Registrar bloqueo excepcional
          </Text>
        </View>
      </View>
      ...
      >
        ...
        {showForm ? (
          <View style={styles.formCard}>
            ...
            <View style={styles.formActions}>
              ...
              <SecondaryButton
                label="Reprogramar"
                onPress={() => Alert.alert('TODO', 'Reprogramación masiva')}
              />
            </View>
          </View>
        ) : (
          ...
          >
            ...
            <View style={styles.newIncidentInfo}>
              <Text style={styles.newIncidentTitle}>
                Registrar nueva incidencia
              </Text>
              <Text style={styles.newIncidentSubtitle}>
                Bloquear horario y notificar clientes afectados
              </Text>
            </View>
            <Ionicons
        ...
        <View style={styles.infoBar}>
          ...
          <Text style={styles.infoText}>
            Al registrar una incidencia se bloquea automáticamente el horario
            afectado y se preparan notificaciones para los clientes con citas
            en ese rango.
          </Text>
        </View>
      </ScrollView>
